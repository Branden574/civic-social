            ...
            <div className="px-4 sm:px-6 py-4">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-xl bg-civic-muted flex items-center justify-center">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 text-xs px-2.5 py-1.5 rounded-xl text-text-muted hover:text-text-secondary hover:bg-surface-hover transition-colors disabled:opacity-50"
                  >
            ...
            <>
              ...
              <div className="mx-4 sm:mx-6 mt-3">
                {isDemo ? (
                  ...
                  <div className="flex items-center justify-between px-3 py-2 bg-warning/5 border border-warning/20 rounded-xl">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between px-3 py-2 bg-surface-elevated rounded-xl border border-border-subtle">
                    <div className="flex items-center gap-2">
              ...
              {error && !loading && bills.length === 0 && (
                <div className="px-4 sm:px-6 py-16 text-center">
                  ...
                  <button
                    onClick={() => fetchBills()}
                    className="px-4 py-2 bg-civic text-white text-sm font-semibold rounded-xl hover:bg-civic-dark transition-colors"
                  >
                    Retry
                  </button>
                </div>
              ...
              <div className="px-4 sm:px-6 mt-3 space-y-3">
                ...
                <form onSubmit={handleSearchSubmit} className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-9 py-2.5 text-sm bg-surface-elevated border border-border-subtle rounded-xl text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-civic/30 focus:border-civic/50 transition-colors"
                  />
                  {browseSearchInput && (
                    <button
                      type="button"
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <select
                    ...
                    className="text-xs px-3 py-1.5 bg-surface-elevated border border-border-subtle rounded-xl text-text-secondary focus:outline-none focus:ring-2 focus:ring-civic/30 cursor-pointer"
                  >
                ...
                <div className="px-4 sm:px-6 py-4">
                  <div className="flex items-center justify-between">
                    <button
                      ...
                      className="flex items-center gap-1 text-xs px-3 py-2 rounded-xl bg-surface-elevated border border-border-subtle text-text-secondary hover:bg-surface-hover disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                    >
                        ...
                        return pages.map((p, idx) =>
                          p === 'ellipsis' ? (
                            ...
                            <button
                              ...
                              onClick={() => goToPage(p)}
                              className={clsx(
                                'text-xs font-medium w-10 h-10 sm:w-8 sm:h-8 rounded-xl transition-colors',
                                p === currentPage
                                  ? 'bg-civic text-white'
                                  : 'bg-surface-elevated text-text-secondary border border-border-subtle hover:bg-surface-hover',
                              )}

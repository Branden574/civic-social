    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={fetchHealth}
              disabled={loading}
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg bg-surface-elevated text-text-secondary border border-border-subtle hover:bg-surface-hover"
            >
                ...
                {mismatchEvents.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {mismatchEvents.map((event, i) => (
                      <div
                        key={i}
                        className="flex items-start gap-2 p-2 bg-danger/5 border border-danger/20 rounded-lg"
                      >
